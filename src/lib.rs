...
#[derive(Debug)]
pub struct GateCompassProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GateCompassProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GateCompass processing");
    
    let mut processor = GateCompassProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GateCompassProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GateCompassProcessor::new(false);
